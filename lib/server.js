...
/**
 * Loads the OAuth Parameters (OAuth Transaction) in the req under 'oauth' object
 *
 * @api public
 */
Server.prototype.transactionLoader = function(options, parse) {
  return transactionLoader(this, options);
};
